...
def main():
    ...
    parser.add_argument("--config", default="configs/lightgcn_ml1m.yaml")
    parser.add_argument("--dataset", default="ml-1m")
    parser.add_argument("--model", default="LightGCN")
    parser.add_argument("--save_name", default="LightGCN_ml1m_top20.pth") 
    ...
    print("Current device in config:", config["device"])
